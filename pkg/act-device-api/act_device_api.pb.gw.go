...
func request_ActDeviceApiService_LogDeviceV1_0(ctx context.Context, marshaler runtime.Marshaler, client ActDeviceApiServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.LogDeviceV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ActDeviceApiService_LogDeviceV1_0(ctx context.Context, marshaler runtime.Marshaler, server ActDeviceApiServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LogDeviceV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.LogDeviceV1(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterActDeviceApiServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ActDeviceApiServiceServer) error {
	...
	mux.Handle("GET", pattern_ActDeviceApiService_LogDeviceV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ozonmp.act_device_api.v1.ActDeviceApiService/LogDeviceV1", runtime.WithHTTPPathPattern("/api/v1/devices/log/{device_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ActDeviceApiService_LogDeviceV1_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ActDeviceApiService_LogDeviceV1_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterActDeviceApiServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ActDeviceApiServiceClient) error {
	...
	mux.Handle("GET", pattern_ActDeviceApiService_LogDeviceV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ozonmp.act_device_api.v1.ActDeviceApiService/LogDeviceV1", runtime.WithHTTPPathPattern("/api/v1/devices/log/{device_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ActDeviceApiService_LogDeviceV1_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
