...
func TestGreet(t *testing.T) {
	...
	tests := []struct {
		...
		{"check <hour> in range [0;6]; value:0", args{"buddy", 0}, "Good night Buddy!"},
		{"check <hour> in range [0;6]; value:6", args{"buddy", 6}, "Good night Buddy!"},
		{"check <hour> in range [23;23]; value:23", args{"buddy", 23}, "Good night Buddy!"},
		{"check <hour> in range [7;12]; value:7", args{"buddy", 7}, "Good morning Buddy!"},
		{"check <hour> in range [7;12]; value:12", args{"buddy", 12}, "Good morning Buddy!"},
		{"check <hour> in range [13;18]; value:13", args{"buddy", 13}, "Hello Buddy!"},
		{"check <hour> in range [13;18]; value:18", args{"buddy", 18}, "Hello Buddy!"},
		{"check <hour> in range [19;22]; value:19", args{"buddy", 19}, "Good evening Buddy!"},
		{"check <hour> in range [19;22]; value:22", args{"buddy", 22}, "Good evening Buddy!"},
		{"check <hour> out of range [0;6]; value:-1", args{"buddy", -1}, "<hour>: range error!"},
		{"check <hour> out of range [23;23]; value:24", args{"buddy", 24}, "<hour>: range error!"},
